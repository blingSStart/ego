...
<div class="w w1 header clearfix">
    <div id="logo"><a href="http://localhost:8082"><img clstag="clickcart|keycount|xincart|logo"
                                                        src="/images/ego-logo.gif" title="返回易购商城首页"
                                                        alt="返回易购商城首页"></a></div>
        ...
        <div class="cart-inner">
            <div class="cart-thead clearfix">
                <div class="column t-checkbox form"><input data-cart="toggle-cb" name="toggle-checkboxes"
                                                           id="toggle-checkboxes_up"
                                                           type="checkbox" checked="" value=""><label
                        for="toggle-checkboxes_up">全选</label></div>
                ...
                <c:forEach items="${cartList}" var="cart">
                    ...
                    <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
                        <div class="item_form clearfix">
                            <div id="parent_checkbox" class="cell p-checkbox"><input data-bind="cbid:1" class="checkbox"
                                                                                     type="checkbox" name="checkItem"
                                                                                     checked=""
                                                                                     value="11345721-1"></div>
                            <div class="cell p-goods">
                                <div class="p-img">
                                    <a href="localhost:8081/item/${cart.id }.html" target="_blank">
                                        <img clstag="clickcart|keycount|xincart|p-imglistcart" src="${cart.images[0]}"
                                             alt="${cart.title}" width="52" height="52">
                                    </a>
                                </div>
                                <div class="p-name">
                                    <a href="http://localhost:8081/item/${cart.id }.html"
                            ...
                            <div id="stock" class="cell p-inventory stock-11345721">有货</div>
            ...
            <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;">
              ...
              <span class="column t-checkbox form">
                  ...
                  <a href="javascripts:;" clstag="clickcart|keycount|xincart|clearcartlink" id="remove-batch">
                          删除选中的商品
                  </a>
              </span>
                        <span class="shopping">
                  ...
                  <a href="localhost:8082" onclick="javascript:location='http://localhost:8082'; return false;"
                     target="_blank"
                     clstag="clickcart|keycount|xincart|coudanlink" id="continue">继续购物</a>
              </span>
                    </div>
                    <div class="cart-total-2014">
                        <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="http://localhost:8086/order/order-cart.html"
