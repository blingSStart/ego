...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="Victor"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="1300000000"/>
		<input type="hidden" name="orderShipping.receiverState" value="北京"/>
		<input type="hidden" name="orderShipping.receiverCity" value="北京"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="大兴区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="亦庄经济技术开发区"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">Victor</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">130****000</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">北京 大兴区 五环外六环里</div>
						<div class="adr-m" limit="30">亦庄经济技术开发区 xxxxxxxxx</div>
    ...
    <div class="goods-suit goods-last">
	 <c:forEach items="${cartList}" var="cart">
		<div class="goods-item goods-item-extra">
			...
			<div class="p-img">
				<a target="_blank" href="http://localhost:8081/item/${cart.id}.html">
