...
<div class="w" id="headers">
		<div id="logo"><a href="http://localhost:8082"><img alt="易购商城" src="/images/ego-logo.gif"></a></div>
		...
		<div class="mc" id="success_detail">	
		    <ul class="list-order">
			    <li class="li-st">
					...
					<div class="fore3">
					   	易购快递 &nbsp; 送货时间: 预计 <c:formatDate value="${date}" pattern="yyyy-MM-dd"></c:formatDate> 送达&nbsp;
					</div>
				</li>
			</ul>
		<!-- 在线支付按钮  -->
