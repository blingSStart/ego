                            ...
                            <div class="user-set userset-lcol">
                                <div class="form">
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" class="itxt" maxlength="20" id="nickName" name="userVo.nickName" value="小明">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" class="itxt" maxlength="20" name="userVo.realName" id="realName" value="张佳明">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" class="itxt itxt1" name="userVo.address" id="address" value="尚学堂上海分校">
